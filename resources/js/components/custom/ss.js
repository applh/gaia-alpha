...
export default {
  ...
  <div class="admin-page">
    <div class="admin-header">
      <h2 class="page-title">sss</h2>
    </div>
    <div class="admin-content">
      <!-- Layout Container -->
      <div class="component-container">
        <!-- Components will be rendered here based on layout -->
        <div class="layout-container"><LayoutRow gutter="md" align="start" justify="start"><div class="layout-div"><LayoutCol :width="12"><div class="layout-div"><div class="component-data-list">Component: data-list (Hello)</div></div></LayoutCol></div></LayoutRow></div>
      </div>
    </div>
  </div>
  `,
  setup() {
    ...
    onMounted(async () => {
        console.log('Component ss mounted');
        await restoreData();
    });
